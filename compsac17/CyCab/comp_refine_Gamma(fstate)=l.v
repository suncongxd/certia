...
Definition FVehicle_Station_hid_m: IA :=
 IAutomaton.hiding FVehicle_Station (ASet.GenActs [&"emrg",&"reset"]).

Definition FVehicle_Station_res_m: IA :=
 IAutomaton.hiding
 ( IAutomaton.restriction FVehicle_Station (ASet.GenActs [&"emrg"]) )
 (ASet.GenActs [&"reset"]).
...
Definition FVehicle_Station_rep_m: IA :=
 IAutomaton.hiding
 ( IAutomaton.replacement FVehicle_Station (&"tau") (ASet.GenActs [&"emrg"]) )
 (ASet.GenActs [&"reset"]).
...
Definition FVehicle_Station_hid_l: IA :=
  ...
  (ASet.GenActs [&"emrg",&"start",&"reset"]).

Definition FVehicle_Station_res_l: IA :=
  IAutomaton.hiding
  ( IAutomaton.restriction FVehicle_Station (ASet.GenActs [&"emrg",&"start"]) )
  (ASet.GenActs [&"reset"]).
...
Definition FVehicle_Station_rep_l: IA :=
  IAutomaton.hiding
  ( IAutomaton.replacement FVehicle_Station (&"tau") (ASet.GenActs [&"emrg",&"start"]) )
  (ASet.GenActs [&"reset"]).
